...
<center><a href="addcategory.php"> <button type="submit" class="btn btn-primary"><i class="fa fa-plus"> RUN CBD MODEL </i></button></a></center> <br>	
...
while($row=mysql_fetch_assoc($rs))
		...
		<tr> 			
                         ...
                         <!-- MAKE FLAG.PHP ???? -->
                         <td> <a href="deletecategory.php?id= <?php echo $row['comment_id'];?>" >   <button class="btn btn-danger"> <i class="fa fa-trash-o"> </i> FLAGGED </a> </button></td>
