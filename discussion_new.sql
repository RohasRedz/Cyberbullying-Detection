...
CREATE TABLE `tbl_comments` (
  ...
  `comment_dislike_count` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 3, 1, 'gfdgdfg', '2019-03-10', 0, 0),
(5, 3, 1, 'dfhdfh', '2019-03-10', 0, 0),
(6, 4, 1, 'dfdsdf', '2019-03-10', 1, 0);
...
(1, 'Rohan Solanki', 9810981902, 'rohasredz@gmail.com', 'Rohan!97', 'male', 'ambala cantt', 'haryana', 'india', '2018-08-08', '2018-08-08', '');
